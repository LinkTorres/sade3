			              ...
			              <div class="panel panel-visible" id="spy5">
			                <div class="panel-heading">
			                  <div class="panel-title hidden-xs">
			                    <span class="glyphicon glyphicon-tasks"></span>Agregar Puesto</div>
			                </div>
                      
			                <div class="panel-body pn">
                        <h5 class="text-center">Ingresa la información</h5>
			                  <form id="agregarForm" data-parsley-validate action="<?php echo base_url();?>principal/SAddPuesto" method="post" role="form">

                          <div class="row">
                              <label class="col-md-2 col-md-offset-1 control-label" for="">Clave</label>
                                <div class="col-xs-6">
                                    <div class="form-group">
                                      <input type="text" name="clave" value="" class="form-control input-sm" placeholder="Clave" required>
                                    </div>
                                </div>
                            </div>
