			              ...
			              <div class="panel panel-visible" id="spy5">
			                <div class="panel-heading">
			                  <div class="panel-title hidden-xs">
			                    <span class="glyphicon glyphicon-tasks"></span>Agregar Turno</div>
			                </div>
                      
			                <div class="panel-body pn">
                        <h5 class="text-center">Ingresa la información</h5>
			                  <form id="agregarForm" data-parsley-validate action="<?php echo base_url();?>principal/SAddTurno" method="post" role="form">
