                  	...
                  	<div class="tab-content">
                        ...
                        <h5 class="text-center">Ingresa la información</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group">
                                      <input type="text" name="clave_posicion" value="" class="form-control input-sm"  required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group">
                                      <input type="text" name="Colaborador_numEmpleado" value="" class="form-control input-sm"  required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
