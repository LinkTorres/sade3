      ...
      <header id="topbar" class="alt">
        ...
        <a class="btn btn-info pull-right" href="<?= base_url() . "principal/nuevoTurno" ?>">Agregar Nuevo <span class="glyphicon glyphicon-book"></span></a>
...
.panel-controls{display: none;}</style>
			              ...
			              <div class="panel panel-visible" id="spy5">
			                <div class="panel-heading">
			                  <div class="panel-title hidden-xs">
			                    <span class="glyphicon glyphicon-tasks"></span>Gestion de Turnos</div>
			                </div>
			                <div class="panel-body pn">
			                  <table class="text-center table table-striped table-hover table-responsive display" id="tabla" cellspacing="0" width="100%">
			                    <thead >
			                      <tr>
			                        <th >ID</th>
			                        <th >Nombre</th>
			                    ...
			                    <tbody >
			                    	...
			                    	<tr>
			                    		<td><?= $item->idTurno ?></td>
			                    		<td><?= $item->Nombre ?></td>
			                    		<td><a class="btn btn-info btn-md" href="<?php echo base_url() . "principal/editarTurno/" . $item->idTurno?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
			                    		<td><button class="eliminar btn btn-danger btn-md" data-val="<?=$item->idTurno ?>"><span class="glyphicon glyphicon-trash"></span></button></td>
			                    	</tr>
			                    	<?php endforeach; ?>
			                    	<?php endif; ?>
			                    </tbody>
  ...
  jQuery(document).ready(function() {
    ...
    Core.init();
    var columnas = [0, 1];
    InitTable("tabla","CATALOGO DE TURNOS" , "landscape" ,columnas);
                        	...
                        	id= OEliminar.data("val");
		                     datastr = "idTurno=" + id ;
		                            $.ajax({
		                                type: "POST", 
		                                async: false, 
		                                url: '<?php echo base_url(); ?>principal/eliminaTurno',
		                                data: datastr, 
		                                dataType: "text",
		                                cache:false,
