      <header id="topbar" class="alt">
        <div class="topbar-left">
          <ol class="breadcrumb">
            ...
            <li class="crumb-icon">
              <a href="<?= base_url() . "principal/puestos" ?>">
			              ...
			              <div class="panel panel-visible" id="spy5">
			                <div class="panel-heading">
			                  <div class="panel-title hidden-xs">
			                    <span class="glyphicon glyphicon-tasks"></span>Editar Puesto</div>
			                </div>
                      
			                <div class="panel-body pn">
                        <?php if(!empty($puesto)): ?>
                        <h5 class="text-center">Actualiza la información</h5>
			                  <form id="actualiza" data-parsley-validate action="<?php echo base_url();?>principal/SEditPuesto" method="post" role="form">
                            <div class="row">
                                <label class="col-md-2 col-md-offset-1 control-label" for="">Clave</label>
                                <div class="col-xs-6">
                                    <div class="form-group">
                                      <input type="text" name="clave" value="<?=$puesto->clave ?>" class="form-control input-sm" readonly required>
                                    </div>
                                </div>
                             ...
                             <div class="row">
                              <label class="col-md-2 col-md-offset-1 control-label" for="">Nombre</label>
                                <div class="col-xs-6">
                                    <div class="form-group">
                                      <input type="text" name="nombre" value="<?=$puesto->nombre ?>" class="form-control input-sm" placeholder="Nombre" required>
                                    </div>
                                </div>
                            </div>
