      <header id="topbar" class="alt">
        <div class="topbar-left">
          <ol class="breadcrumb">
            ...
            <li class="crumb-icon">
              <a href="<?= base_url() . "principal/regimenes" ?>">
			              ...
			              <div class="panel panel-visible" id="spy5">
			                <div class="panel-heading">
			                  <div class="panel-title hidden-xs">
			                    <span class="glyphicon glyphicon-tasks"></span>Editar Regimen</div>
			                </div>
                      
			                <div class="panel-body pn">
                        <?php if(!empty($regimen)): ?>
                        <h5 class="text-center">Actualiza la información</h5>
			                  <form id="actualiza" data-parsley-validate action="<?php echo base_url();?>principal/SEditRegimen" method="post" role="form">
                            <div class="row">
                                <label class="col-md-2 col-md-offset-1 control-label" for="">ID</label>
                                <div class="col-xs-6">
                                    <div class="form-group">
                                      <input type="text" name="idRegimen" value="<?=$regimen->idRegimen ?>" class="form-control input-sm" readonly required>
                                    </div>
                                </div>
                             ...
                             <div class="row">
                              <label class="col-md-2 col-md-offset-1 control-label" for="">Nombre</label>
                                <div class="col-xs-6">
                                    <div class="form-group">
                                      <input type="text" name="nombre" value="<?=$regimen->Nombre ?>" class="form-control input-sm" placeholder="Nombre" required>
                                    </div>
                                </div>
                            </div>
