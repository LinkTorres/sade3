			              ...
			              <div class="panel panel-visible" id="spy5">
			                <div class="panel-heading">
			                  <div class="panel-title hidden-xs">
			                    <span class="glyphicon glyphicon-tasks"></span>Reporte de Altas</div>
			                </div>
			                <div class="panel-body pn">
                         <form id="filtroReporte" data-parsley-validate action="<?php echo base_url();?>reportes/filtroAltas" method="post" role="form">
