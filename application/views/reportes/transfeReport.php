			              ...
			              <div class="panel panel-visible" id="spy5">
			                <div class="panel-heading">
			                  <div class="panel-title hidden-xs">
			                    <span class="glyphicon glyphicon-tasks"></span>Reporte de Transferencias</div>
			                </div>
			                <div class="panel-body pn">
                         <form id="filtroTransfe" data-parsley-validate action="<?php echo base_url();?>reportes/filtroTransfe" method="post" role="form">
                            ...
                            <div class="row">
                              <div class="col-xs-10 col-xs-offset-1">
                                  <table class="hidden text-center table table-striped table-hover display" id="tablaTransfe" cellspacing="0" width="100%">
                                    <thead >
                                      <tr>
                                        <th >#Colaborador</th>
                                        <th >Nombre</th>
